#!/usr/bin/env python3
"""
python FDR_correct_TCA_log_vert_loading_gams.py \
    ...
    --outdir "/cbica/projects/bbl_22q/analysis/topography/results/091426_TCA_vert_normed_loadings_FDR_pval_beta_logTC"
...
def main():
    ...
    with h5py.File(h5_path, "r") as f:
        ...
        beta = f["beta_logTC"][:].astype(np.float64)   # (TOTAL_LEN,)
        pval = f["p_logTC"][:].astype(np.float64)      # (TOTAL_LEN,)
        ...
        for net in range(1, N_NET + 1):
            ...
            out_path = outdir / f"logTC_gam_vert_loadings_PFN_{net:02d}_beta_fdr.csv"
