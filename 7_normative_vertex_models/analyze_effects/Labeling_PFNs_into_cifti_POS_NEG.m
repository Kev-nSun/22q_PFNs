...
% Input/output folder
VisualizeFolder = ...
    'C:/Users/kevin/OneDrive/Documents/NGG_PhD/Alexander-Bloch/22q_Project/Analyses/Results/TCA_PFN_loadings_gam_results/NORMED/Maps/PFN_ID_clusts/';

% Map naming components
MapPrefix = 'logTC';
Signs     = {'POS','NEG'};
MapSuffix = 'PFN_ID_clust_main_effects_50mm';
...
for m = 1:numel(Signs)
    ...
    lh_field = [sign '_vertex_weight_clust_lh'];
    rh_field = [sign '_vertex_weight_clust_rh'];
