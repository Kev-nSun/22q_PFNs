...
Fig <- ggplot(data, aes(EffectRank, EffectSizes)) +
  ...
  labs(title = "Functional Areal Scaling- CLR", x = "Networks", y = paste0("PFN Allometry")) + theme_classic() +
...
Fig
ggsave(paste0("../../Results/PNC_PFN_Age/CLR/PNC_PFNs_CLR_scaling_plot.png"), width = 19, height = 16, dpi = 600, units = "cm")
```
