...
write_csv(log_log_results_fdr,paste0(dout,"/PNC_group_log_log_summary_results.csv"))
```
...
write_csv(log_log_ANOVA_fdr,paste0(dout,"/PNC_group_log_log_ANOVA_summary_results.csv"))
```
...
BorderColor2 <- c("#E76178", "#7499C2", "#F5BA2E", "#FFFFFF", "#00A131",
...
Fig <- ggplot(data, aes(EffectRank, EffectSizes)) +
  ...
  labs(title = "Group Atlas Scaling in PNC + s(age)", x = "Networks", y = paste0("Cortical Scaling Coefficient (β)")) + theme_classic() +
...
Fig
ggsave(paste0("../../Results/PNC_group_net_areas_log-log_age_cov/PNC_group_log_log_scaling_plot_0.8-1.3.png"), width = 19, height = 16, dpi = 600, units = "cm");
```
...
plot(PFN1_gam, select = 1, shade = TRUE, main = "PFN1, s(age)",
     xlab = "Age (years)", ylab = "Effect on log(PFN1)")

plot(PFN2_gam, select = 1, shade = TRUE, main = "PFN2, s(age)",
     xlab = "Age (years)", ylab = "Effect on log(PFN2)")

plot(PFN3_gam, select = 1, shade = TRUE, main = "PFN3, s(age)",
     xlab = "Age (years)", ylab = "Effect on log(PFN3)")
...
plot(PFN13_gam, select = 1, shade = TRUE, main = "PFN13, s(age)",
     xlab = "Age (years)", ylab = "Effect on log(PFN13)")

plot(PFN14_gam, select = 1, shade = TRUE, main = "PFN14, s(age)",
     xlab = "Age (years)", ylab = "Effect on log(PFN14)")

plot(PFN15_gam, select = 1, shade = TRUE, main = "PFN15, s(age)",
     xlab = "Age (years)", ylab = "Effect on log(PFN15)")

plot(PFN17_gam, select = 1, shade = TRUE, main = "PFN17, s(age)",
     xlab = "Age (years)", ylab = "Effect on log(PFN17)")
...
#tab_model(PFN14_gam_no_age,pred.labels = c("Intercept","log TC Area","Sex","Euler Number","Median FD"),dv.labels=c("log PFN14"),digits=2,digits.p=2,show.se=TRUE,show.stat=TRUE,string.stat = "t",string.se = "Std. Error",show.intercept=TRUE,show.ci = FALSE, p.adjust="none",p.style="scientific", file = paste(dout,"/PNC_Group_PFN14_area_TC_area.doc", sep = ""))
...
#tab_model(PFN16_gam_no_age,pred.labels = c("Intercept","log TC Area","Sex","Euler Number","Median FD"),dv.labels=c("log PFN16"),digits=2,digits.p=2,show.se=TRUE,show.stat=TRUE,string.stat = "t",string.se = "Std. Error",show.intercept=TRUE,show.ci = FALSE, p.adjust="none",p.style="scientific", file = paste(dout,"/PNC_Group_PFN16_area_TC_area.doc", sep = ""))
...
write_csv(log_log_results_no_age_cov_fdr,paste0(dout,"/PNC_group_log_log_no_age_summary_results.csv"))
```
...
write_csv(log_log_ANOVA_no_age_fdr,paste0(dout,"/PNC_Group_log_log_ANOVA_no_age_summary_results.csv"))
```
...
Fig
ggsave(paste0("../../Results/PNC_group_net_areas_log-log/PNC_group_log_log_scaling_no_age_plot_0.8-1.3.png"), width = 19, height = 16, dpi = 600, units = "cm");
```

#Get age effects and significance on group network surface area scaling
```{r}
dout <- "../../Results/PNC_group_net_areas_log-log_age_cov"
...
write_csv(delta_adj_R2_pvals_fdr,paste0(dout,"/PNC_group_delta_age_adj_R2_fdr_pvals.csv"))
...
write_csv(lm_age_effect_sizes,paste0(dout,"/PNC_group_lm_age_effect_size_for_sign.csv"))
...
BorderColor2 <- c("#E76178", "#7499C2", "#F5BA2E", "#FFFFFF", "#FFFFFF",
                 "#FFFFFF", "#FFFFFF", "#E76178", "#FFFFFF", "#FFFFFF",
                 "#7499C2", "#FFFFFF", "#7499C2", "#00A131", "#F5BA2E", 
                 "#FFFFFF", "#F5BA2E");
# Change the color order
BorderColor <- BorderColor1[pfn_inAscend]
BorderColor3 <- BorderColor2[pfn_inAscend]
...
LineType <- c("solid", "solid", "solid", "dashed", "dashed",
              ...
              "solid", "dashed", "solid", "solid", "solid",
              "dashed", "solid");
...
Fig <- ggplot(data, aes(EffectRank, EffectSizes)) +
  ...
  labs(title = "Group Atlas Age Effects in PNC", x = "Networks", y = paste0("Age Effect (ΔAdj R2)")) + theme_classic() +
  theme(plot.title = ggtext::element_markdown(size=25, hjust = 0.5)) +
  theme(axis.text.x = ggtext::element_markdown(size= 25, color = BorderColor), 
        axis.text.y = ggtext::element_markdown(size= 25, color = "black"), 
        axis.title=ggtext::element_markdown(size = 25)) +
...
Fig
ggsave(paste0("../../Results/PNC_group_net_areas_log-log_age_cov/PNC_group_age_effect-delta_adj_R2_plot.png"), width = 19, height = 16, dpi = 600, units = "cm")
```
...
Fig <- ggplot(data, aes(EffectRank, EffectSizes)) +
  geom_bar(stat = "identity", fill=BorderColor3[sorted_signed_effects], 
           colour = BorderColor[sorted_signed_effects], linetype = LineType, width = 0.8) + 
  labs(title = "Group Atlas Age Effects in PNC", x = "Networks", y = paste0("Age Effect (Partial R2)")) + theme_classic() +
  theme(plot.title = ggtext::element_markdown(size=25, hjust = 0.5)) +
  theme(axis.text.x = ggtext::element_markdown(size= 25, color = BorderColor), 
        axis.text.y = ggtext::element_markdown(size= 25, color = "black"), 
        axis.title=ggtext::element_markdown(size = 25)) +
  ...
  scale_x_discrete(labels = as.character(pfn_inAscend),limits = as.character(sorted_signed_effects))
Fig
ggsave(paste0("../../Results/PNC_group_net_areas_log-log_age_cov/PNC_group_age_effect-partial_R2_plot.png"), width = 19, height = 16, dpi = 600, units = "cm")
```
...
#tab_model(PFN5_gam_mod,pred.labels = c("Intercept","log TC Area","Sex","Euler Number","Median FD","Age Spline","Age Spline by log TC Area"),dv.labels=c("log PFN5"),digits=2,digits.p=2,show.se=TRUE,show.stat=TRUE,string.stat = "t",string.se = "Std. Error",show.intercept=TRUE,show.ci = FALSE, p.adjust="none",p.style="scientific", file = paste(dout,"/PNC_Group_PFN5_area_TC_area_age_interaction.doc", sep = ""))
...
#tab_model(PFN8_gam_mod,pred.labels = c("Intercept","log TC Area","Sex","Euler Number","Median FD","Age Spline","Age Spline by log TC Area"),dv.labels=c("log PFN8"),digits=2,digits.p=2,show.se=TRUE,show.stat=TRUE,string.stat = "t",string.se = "Std. Error",show.intercept=TRUE,show.ci = FALSE, p.adjust="none",p.style="scientific", file = paste(dout,"/PNC_Group_PFN8_area_TC_area_age_interaction.doc", sep = ""))
...
#tab_model(PFN10_gam_mod,pred.labels = c("Intercept","log TC Area","Sex","Euler Number","Median FD","Age Spline","Age Spline by log TC Area"),dv.labels=c("log PFN10"),digits=2,digits.p=2,show.se=TRUE,show.stat=TRUE,string.stat = "t",string.se = "Std. Error",show.intercept=TRUE,show.ci = FALSE, p.adjust="none",p.style="scientific", file = paste(dout,"/PNC_Group_PFN10_area_TC_area_age_interaction.doc", sep = ""))
...
#tab_model(PFN13_gam_mod,pred.labels = c("Intercept","log TC Area","Sex","Euler Number","Median FD","Age Spline","Age Spline by log TC Area"),dv.labels=c("log PFN13"),digits=2,digits.p=2,show.se=TRUE,show.stat=TRUE,string.stat = "t",string.se = "Std. Error",show.intercept=TRUE,show.ci = FALSE, p.adjust="none",p.style="scientific", file = paste(dout,"/PNC_Group_PFN13_area_TC_area_age_interaction.doc", sep = ""))
...
summary(gam(log(TC_area)~sex+euler+median_fd_combined+s(age,k=4),data=PNC_all))
TC_area_gam<-gam(log(TC_area)~sex+euler+median_fd_combined+s(age,k=4),data=PNC_all)
#tab_model(TC_area_gam,pred.labels = c("Intercept","Sex","Euler Number","Median FD","Age Spline"),dv.labels=c("log PFN1"),digits=2,digits.p=2,show.se=TRUE,show.stat=TRUE,string.stat = "t",string.se = "Std. Error",show.intercept=TRUE,show.ci = FALSE, p.adjust="none",p.style="scientific", file = paste(dout,"/TC_area_age_spline.doc", sep = ""))

draw(TC_area_gam)

summary(gam(log(TC_area)~sex+euler+median_fd_combined,data=PNC_all))
TC_area_gam_no_age<-gam(log(TC_area)~sex+euler+median_fd_combined,data=PNC_all)

summary(lm(log(TC_area)~sex+euler+median_fd_combined+age,data=PNC_all))
TC_area_lm_age<-lm(log(TC_area)~sex+euler+median_fd_combined+age,data=PNC_all)
...
write_csv(TC_area_age_results,paste0(dout,"/PNC_TC_area_age_effect_results.csv"))
```
