...
writeMat(paste0(clust_PFN_ID_dir,"22q_POS_PFN_ID_clust_50mm_L.mat"), x = pos_names_list)
...
writeMat(paste0(clust_PFN_ID_dir,"22q_POS_PFN_ID_clust_50mm_R.mat"), x = pos_names_list)
...
writeMat(paste0(clust_PFN_ID_dir,"22q_NEG_PFN_ID_clust_50mm_L.mat"), x = neg_names_list)
# For R hemi, ensure that both the list and its elements are named
neg_names_list <- list()
neg_names_list$NEG_vertex_weight_clust_rh <- NEG_vertex_weight_clust_rh
writeMat(paste0(clust_PFN_ID_dir,"22q_NEG_PFN_ID_clust_50mm_R.mat"), x = neg_names_list)