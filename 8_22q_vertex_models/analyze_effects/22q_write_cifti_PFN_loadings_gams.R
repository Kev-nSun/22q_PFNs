...
# Define out directory for maps and subdirectories
dirout <- "C:/Users/kevin/OneDrive/Documents/NGG_PhD/Alexander-Bloch/22q_Project/Analyses/Results/22q_PFN_loadings_gam_results_subclass/Normed_TCA/Maps/"
dir.create(dirout)
...
for (PFN in c(1:17))
{
  ...
  outfile <- paste0(dirout,'PFN',PFN,'_22q_PFN_loading_gam_weights_fdr_thresholded')
  ...
  outfile_abs <- paste0(abs_dirout,'/PFN',PFN,'_22q_PFN_loading_gam_weights_fdr_thresholded_ABS')
  ...
  infile <- outfile_abs
  clust_file <- paste0(bin_dirout,'/PFN',PFN,'_50mm_cluster_binary_22q.dscalar.nii')
  ...
  clust_outfile <- paste0(clust_dirout,'/PFN',PFN,'_22q_PFN_loading_gam_weights_fdr_thresholded_50mm_CLUST')
...
for (PFN in c(1:17))
{
  ...
  #define output file for averaged map
  outfile <- paste0(unthres_dirout,'PFN',PFN,'_22q_PFN_loading_gam_weights_unthresholded')
...
#define output file for averaged map
outfile <- paste0(unthres_dirout,'ABS_MAX_22q_PFN_loading_gam_weights_unthres')
