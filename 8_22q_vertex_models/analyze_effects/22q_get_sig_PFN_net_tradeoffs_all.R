...
# indir <- "C:/Users/kevin/OneDrive/Documents/NGG_PhD/Alexander-Bloch/22q_Project/Analyses/Results/22q_PFN_loadings_gam_results_subclass/091426_22q_logTC_vert_normed_loadings_FDR_pval_beta_subclass/"
# cov_mod <- "_TCA"
...
dir.create(dirout, showWarnings = FALSE, recursive = TRUE)
indir <- "C:/Users/kevin/OneDrive/Documents/NGG_PhD/Alexander-Bloch/22q_Project/Analyses/Results/22q_PFN_loadings_gam_results_subclass/091426_22q_no_TCA_vert_normed_loadings_FDR_pval_beta_subclass/"
cov_mod <- "_no_TCA"
...
filename <- paste0("stat_22q_tradeoff_mean_betas_all17",cov_mod,".csv")
...
filename <- paste0("stat_22q_tradeoff_overlap_counts_all17",cov_mod,".csv")
...
filename <- paste0("stat_22q_tradeoff_target_sig_counts_all17",cov_mod,".csv")
...
filename <- paste0("stat_22q_tradeoff_target_sig_opposite_counts_all17",cov_mod,".csv")
...
filename <- paste0("stat_22q_tradeoff_target_sig_opposite_proportions_all17",cov_mod,".csv")
