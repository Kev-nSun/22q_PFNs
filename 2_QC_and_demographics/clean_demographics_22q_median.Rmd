...
comb_22q
ggsave(paste0("../Histograms/22q_median_FD_combined_10-23yo.png"), width = 19, height = 16, dpi = 600, units = "cm")
...
idemo_22q
ggsave(paste0("../Histograms/22q_median_FD_idemo_10-23yo.png"), width = 19, height = 16, dpi = 600, units = "cm")
...
rest_22q <- ggplot(age_range_matched_22q, aes(x = median_fd_rest)) +
  ...
  scale_y_continuous(breaks = c(0, 2, 4, 6, 8, 10)) # Specify desired tick mark positions
rest_22q
ggsave(paste0("../Histograms/22q_median_FD_rest_10-23yo.png"), width = 19, height = 16, dpi = 600, units = "cm")
