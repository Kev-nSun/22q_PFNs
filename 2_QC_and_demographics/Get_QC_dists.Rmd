...
comb_22q
ggsave(paste0("../Histograms/22q_mean_FD_combined.png"), width = 19, height = 16, dpi = 600, units = "cm")
...
comb_PNC <- ggplot(summary_PNC, aes(x = mean_fd_combined)) +
  ...
  theme(plot.title = element_text(hjust = 0.5))
comb_PNC
ggsave(paste0("../Histograms/PNC_mean_FD_combined.png"), width = 19, height = 16, dpi = 600, units = "cm")
...
idemo_22q
ggsave(paste0("../Histograms/22q_mean_FD_idemo.png"), width = 19, height = 16, dpi = 600, units = "cm")
...
idemo_PNC <- ggplot(summary_PNC, aes(x = mean_fd_idemo)) +
  ...
  theme(plot.title = element_text(hjust = 0.5))
idemo_PNC
ggsave(paste0("../Histograms/PNC_mean_FD_idemo.png"), width = 19, height = 16, dpi = 600, units = "cm")
...
rest_22q <- ggplot(summary_22q, aes(x = mean_fd_rest)) +
  ...
  scale_y_continuous(breaks = c(0, 2, 4, 6, 8, 10)) # Specify desired tick mark positions
rest_22q
ggsave(paste0("../Histograms/22q_mean_FD_rest.png"), width = 19, height = 16, dpi = 600, units = "cm")
...
rest_PNC <- ggplot(summary_PNC, aes(x = mean_fd_rest)) +
  ...
  theme(plot.title = element_text(hjust = 0.5))
rest_PNC
ggsave(paste0("../Histograms/PNC_mean_FD_rest.png"), width = 19, height = 16, dpi = 600, units = "cm")
...
mean_22q <- c(median_FD_comb_avg_22q, median_FD_idemo_avg_22q, median_FD_rest_avg_22q)
SD_22q <- c(median_FD_comb_SD_22q, median_FD_idemo_SD_22q, median_FD_rest_SD_22q)
mean_PNC <- c(median_FD_comb_avg_PNC, median_FD_idemo_avg_PNC, median_FD_rest_avg_PNC)
SD_PNC <- c(median_FD_comb_SD_PNC, median_FD_idemo_SD_PNC, median_FD_rest_SD_PNC)

median_FD_df <- data.frame(mean_22q,SD_22q,mean_PNC,SD_PNC)
...
comb_22q <- ggplot(summary_22q, aes(x = median_fd_combined)) +
  ...
  scale_y_continuous(breaks = c(0, 2, 4, 6, 8, 10)) # Specify desired tick mark positions
comb_22q
ggsave(paste0("../Histograms/22q_median_FD_combined.png"), width = 19, height = 16, dpi = 600, units = "cm")
...
comb_PNC <- ggplot(summary_PNC, aes(x = median_fd_combined)) +
  ...
  theme(plot.title = element_text(hjust = 0.5))
comb_PNC
ggsave(paste0("../Histograms/PNC_median_FD_combined.png"), width = 19, height = 16, dpi = 600, units = "cm")
...
idemo_22q <- ggplot(summary_22q, aes(x = median_fd_idemo)) +
  ...
  scale_y_continuous(breaks = c(0, 2, 4, 6, 8, 10, 12)) # Specify desired tick mark positions
idemo_22q
ggsave(paste0("../Histograms/22q_median_FD_idemo.png"), width = 19, height = 16, dpi = 600, units = "cm")
...
idemo_PNC <- ggplot(summary_PNC, aes(x = median_fd_idemo)) +
  ...
  theme(plot.title = element_text(hjust = 0.5))
idemo_PNC
ggsave(paste0("../Histograms/PNC_median_FD_idemo.png"), width = 19, height = 16, dpi = 600, units = "cm")
...
rest_22q <- ggplot(summary_22q, aes(x = median_fd_rest)) +
  ...
  scale_y_continuous(breaks = c(0, 2, 4, 6, 8, 10)) # Specify desired tick mark positions
rest_22q
ggsave(paste0("../Histograms/22q_median_FD_rest.png"), width = 19, height = 16, dpi = 600, units = "cm")
...
rest_PNC <- ggplot(summary_PNC, aes(x = median_fd_rest)) +
  ...
  theme(plot.title = element_text(hjust = 0.5))
rest_PNC
ggsave(paste0("../Histograms/PNC_median_FD_rest.png"), width = 19, height = 16, dpi = 600, units = "cm")
